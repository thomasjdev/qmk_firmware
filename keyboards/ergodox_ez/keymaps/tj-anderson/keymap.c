...
#define MOVE 1 // Movement Layer
#define FN 2 // Function Key Layer
#define FN1 3 // Additional function layer
...
#define KC_FN1      MO(FN1)
#define KC_HESC     HYPR_T(KC_ESC)
 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  |  Pgup|           |  Hm  |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | CAG/Esc|   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |   ;  |   '    |
 * |--------+------+------+------+------+------|  Pgdn|           |  End |------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |   /  | RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  MV  |  FN  |  C   |  A   |  G  |                                       |   MV |   FN | Cmd  |  Alt |  Ctl |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |   {  |   [  |       |   ]  |   }  |
 *                                 ,------|------|------|       |------+--------+------.
 ...
 */
    [MOVE] = LAYOUT_ergodox(
        // left hand
        KC_TRNS, KC_TRNS, KC_TRNS, C(G(S(KC_3))), C(G(S(KC_4))), KC_TRNS, KC_TRNS,
        ...
        KC_VOLD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_RPRN, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_HOME, KC_END,
        KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS),
